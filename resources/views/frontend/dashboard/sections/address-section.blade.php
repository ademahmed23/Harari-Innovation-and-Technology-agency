<div class="tab-pane fade" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
    <div class="fp_dashboard_body address_body">
        <h3>address <a class="dash_add_new_address"><i class="far fa-plus"></i> {{__('frontend.add new')}}
            </a>
        </h3>
        <div class="fp_dashboard_address show_edit_address">
            ...
            <div class="fp_dashboard_new_address ">
                <form action="{{ route('address.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>{{__('frontend.add new address')}}</h4>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" class="common_btn">{{__('frontend.save
                                address')}}</button>
                        </div>
                    </div>
                </form>
            ...
            <div class="fp_dashboard_edit_address edit_section_{{ $address->id }}" >
                <form action="{{ route('address.update', $address->id) }}" method="Post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>{{__('frontend.Edit Address')}}</h4>
                        </div>
