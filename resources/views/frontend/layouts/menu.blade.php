...
<nav class="navbar navbar-expand-lg main_menu">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset(config('settings.logo')) }}" alt="" class="img-fluid img-logo">
        </a>
            ...
            <ul class="menu_icon d-flex flex-wrap">
                ...
                <li>
                    <a class="common_btn" href="#" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop">{{ __('frontend.Book Now') }}</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="fp__menu_cart_area">
    <div class="fp__menu_cart_boody">
        <div class="fp__menu_cart_header">
            <h5>{{ __('frontend.total item') }} (<span class="cart_count"
                    style="font-size: 16px">{{ count(Cart::content()) }}</span>)</h5>
        ...
        <p class="subtotal">{{ __('admin.sub total') }} <span
                class="cart_subtotal">{{ currencyPosition(cartTotal()) }}</span></p>
