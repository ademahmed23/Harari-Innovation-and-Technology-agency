@php
    ...
    $footerInfo = \App\Models\FooterInfo::Where('language',$lang)->first();
                ...
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        <a class="footer_logo" href="{{route('home')}}">
                            <img src="{{ asset(config('settings.footer_logo')) }}" alt="" class="img-fluid w-100 img-logo">
                        </a>
                        {{-- @if (@$footerInfo->language) --}}
                ...
                <div class="col-12">
                    <div class="fp__footer_bottom_text d-flex flex-wrap justify-content-between">
                        @if (@$footerInfo->copyright)
                            <p>copyright &copy 2024 {{ @$footerInfo->copyright }} All Rights Reserved.</p>
                        @endif
                        <ul class="d-flex flex-wrap">
