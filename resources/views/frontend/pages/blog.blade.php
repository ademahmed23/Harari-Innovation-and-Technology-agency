        ...
        <div class="fp__breadcrumb_overlay">
            <div class="container">
                <div class="fp__breadcrumb_text">
                    <h1>{{__('frontend.Our Latest News')}}</h1>
                    <ul>
                        <li><a href="#">{{__('frontend.home')}}</a></li>
                        <li><a href="#">{{__('frontend.blogs')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <form class="fp__search_menu_form mb-4" action="{{ route('blogs') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-3">
                        <button type="submit" class="common_btn">{{__('frontend.search')}}</button>
                    </div>
                </div>
            </form>
            <div class="row">
                ...
                @endforeach
                @if ($blogs->isEmpty())
                    <h5 class="text-center">{{__('frontend.No Blog Found!')}}</h5>
                @endif
