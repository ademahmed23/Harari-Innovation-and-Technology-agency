            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="fp__payment_area">
                        ...
                        @endif
                        @if(config('gatewaySettings.chapa_status'))
                        <div class="col-lg-3 col-6 col-sm-4 col-md-3 wow fadeInUp" data-wow-duration="1s">
                            <img class="img-sm" style="max-width: 170x; max-height:120px;" src="{{ asset('uploads/media_64e58838d3a512.jpg') }}" alt="Chapa">

                            <form method="POST" action="{{ route('pay')}}" id="paymentForm">
                                {{ csrf_field() }}
                                <input class="common_btn" type="submit"  value="Buy" />
                            </form>
