                        ...
                        <div class="wrap">
                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    <label for="menu" class="selected-menu">{{__('frontend.select menu edit')}}</label>
                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    <p id="menu-item-url-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <span>{{__('frontend.Pages')}} <code>(optional)</code></span>&nbsp;&nbsp;&nbsp;
                                                                        </label>
                                                                        <select class="form-control" id="custom-menu-item-pages">
                                                                            <option value="">{{__('frontend.Select')}}</option>
                                                                            <option value="Home" data-url="/">{{__('frontend.Home')}}</option>
                                                                            <option value="Products" data-url="/products">{{__('frontend.Service')}}</option>
                                                                            <option value="About" data-url="/about">{{__('frontend.About')}}</option>
                                                                            <option value="Blogs" data-url="/blogs">{{__('frontend.Blogs')}}</option>
                                                                            <option value="Contact" data-url="/contact">{{__('frontend.Contact')}}</option>
                                                                            <option value="Chefs" data-url="/chef">{{__('frontend.Team')}}</option>
                                                                            <option value="Testimonials" data-url="/testimonials">{{__('frontend.Testimonials')}}</option>
                                                                            <option value="Privacy Policy" data-url="/privacy-policy">{{__('frontend.Privacy Policy')}}</option>
                                                                            <option value="Trams and Conditions" data-url="/trams-and-conditions">{{__('frontend.Trams and Conditions')}}</option>
