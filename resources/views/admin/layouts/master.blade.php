...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admin/assets/css/bootstrap4-toggle.min.css') }}">
    ...
    <script>
        ...
        var loggedInUserId = Auth()->guard('admin')->user()-id->check();
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Developed By <a href="https://ademahmed.com">ademahmed</a>
                </div>
