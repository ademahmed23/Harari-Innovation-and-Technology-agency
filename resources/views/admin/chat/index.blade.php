                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            @php
                                ...
                                $unseenMessages = \App\Models\Chat::where(['sender_id' => $chatUser->id, 'receiver_id' => auth()->guard('admin')->user()->id, 'seen' => 0])->count();
...
@push('scripts')
    <script>
        $(document).ready(function(){
            ...
            var avatar = "{{ asset(auth()->guard('admin')->user()->avator) }}";
            $('#receiver_id').val("");
