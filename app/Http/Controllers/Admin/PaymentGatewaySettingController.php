...
class PaymentGatewaySettingController extends Controller
{
    ...
    //////////////////////////////////
    function chapapaySettingUpdate(Request $request)  {
        $validatedData = $request->validate([
            'chapa_status' => ['required', 'boolean'],
            'chapa_account_mode' => ['required', 'in:test,live'],
            'chapa_country' => ['required'],
            'chapa_currency' => ['required'],
            'chapa_rate' => ['required', 'numeric'],
            'chapa_api_key' => ['required'],
            //  'chapa_secret_key' => ['required'],
            // 'chapa_app_id' => ['required'],
        ]);

        if($request->hasFile('chapa_logo')){
            $request->validate([
                'chapa_logo' => ['nullable', 'image']
            ]);

            $imagePath = $this->uploadImage($request, 'chapa_logo');
