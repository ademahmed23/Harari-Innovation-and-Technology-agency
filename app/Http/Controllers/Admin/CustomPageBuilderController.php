...
class CustomPageBuilderController extends Controller
{
    ...
    public function index(CustomPageBuilderDataTable $dataTable) : View|JsonResponse
    {
        ...
        return $dataTable->render('admin.custom-page-builder.index' ,compact('languages'));
    }
    ...
    {
        $languages = Language::all();
        return view('admin.custom-page-builder.create', compact('langauges'));
    }
    ...
    public function store(Request $request) : RedirectResponse
    {
        ...
        $page->language = $request->langauge;
    ...
    public function edit(string $id) : View
    {
        ...
        return view('admin.custom-page-builder.edit', compact('page', 'languages'));
    }
