...
class WhyChooseUsController extends Controller
{
    ...
    public function index(WhyChooseUsDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.why-choose-us.index', compact('titles', 'languages'));
    }
    ...
    {
        $languages = Language::all();
        return view('admin.why-choose-us.create', compact('languages'));
    }
    ...
    public function edit(string $id) : View
    {
        ...
        return view('admin.why-choose-us.edit', compact('whyChooseUs','languages'));
    }
