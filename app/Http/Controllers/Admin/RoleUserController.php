...
use App\Http\Requests\Admin\AdminRoleUserStoreRequest;
use App\Http\Requests\Admin\AdminRoleUserUpdateRequest;
...
class RoleUserController extends Controller
{
    ...
    public function store(AdminRoleUserStoreRequest $request) : RedirectResponse
    {
        ...
        try {
            ...
            toastr(__('admin.Created Successfully!'), 'success');
    ...
    public function update(AdminRoleUserUpdateRequest $request, string $id)
    {
        ...
        toastr(__('admin.Update Successfully!'), 'success');
