...
class ChefController extends Controller
{
    ...
    { 
        ...
        $titles = SectionTitle::where('language', getLangauge())->whereIn('key', $keys)->pluck('value','key');
        return $dataTable->render('admin.chef.index', compact('titles','languages'));
    }
    ...
    { 
        $languages = Language::all();
        return view('admin.chef.create', compact('languages'));
    }
    ...
    public function store(ChefCreateRequest $request) : RedirectResponse
    {
        ...
        $chef->language = $request->language;
